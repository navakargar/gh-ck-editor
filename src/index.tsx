...
} from "./CKEditor/CKEditorComponent";
import HtmlPreviewComponent, {
  IHtmlPreviewComponentProps,
} from "./HtmlPreview/HtmlPreviewComponent";
...
const App: React.FC = () => {
  ...
  const HelperTextComponent: React.FC<{ text: string }> = ({ text }) => (
...
// Render the app for development (guard for SSR / non-browser)
...
const CKEditor: React.FC<ICKEditorComponentProps> = (
  props: ICKEditorComponentProps
) => {
  const {
    value,
    onChangeValue,
...
const HtmlPreview: React.FC<IHtmlPreviewComponentProps> = (
